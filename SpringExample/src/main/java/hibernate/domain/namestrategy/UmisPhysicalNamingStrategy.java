package hibernate.domain.namestrategy;
...
/**
 * 自定义从java类名到数据库表名的映射规则
 * 命名替换，java： accountNumber ，替换后： acc_num
 */
public class UmisPhysicalNamingStrategy implements PhysicalNamingStrategy {
