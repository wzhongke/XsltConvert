...
//            strategy = GenerationType.AUTO  // 使用hibernate生成的ID
    ...
    // 使用自定义的类型转换器
    @Type(type="hibernate.domain.namestrategy.domain.PersonAddressUserType")
    @Columns(columns = {
            @Column(name = "address"),
            @Column(name = "phone")
    })
    ...
    @Type(type="hibernate.domain.namestrategy.customtype.BitSetUserType")
...
//            "    COALESCE(' ' + name, '')" +
//            ")")
//    private String personPerpority;
